...
-- ============================================================
-- 048 - Loop #6 It.2: reto de km medido desde vehicles.initial_odometer.
-- ============================================================
create or replace function public.challenge_stats_tenant(p_tenant uuid)
returns table(
  user_id uuid, name text, email text,
...
-- ============================================================
-- 055 - Trigger robusto: re-vincula por email borrando+recreando (preserva
-- is_admin), sin depender de ON UPDATE CASCADE. Corrige 054.
-- ============================================================
create or replace function public.handle_new_auth_user()
returns trigger
language plpgsql
...
-- ============================================================
-- 057 - Loop #8 It.1: descuentos por precio real + ahorro + validación 15d
-- ============================================================
alter table public.users
