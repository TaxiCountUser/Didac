...
// clave de subida; si no, se firma con la debug para poder probar el APK
// por sideload (instalación manual). El keystore NUNCA se sube al repo.
...
android {
    ...
    buildTypes {
        release {
            // Con key.properties -> firma de subida (Play); sin él -> debug (sideload).
