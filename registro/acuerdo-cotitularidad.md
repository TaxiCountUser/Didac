...
**Primero.** Que D. Didac Oliveras Galvez es autor del programa de ordenador denominado
**TaxiCount**, plataforma destinada a la gestión económica y administrativa de flotas de taxi,
cuyo desarrollo inició el 19 de junio de 2026, y que en adelante se denomina «la Obra».

**Segundo.** Que D. Jordi Pujadas Serra ha prestado su asistencia en materia de seguridad de
la aplicación y protección de datos personales y que, en el marco de esa colaboración,
**ambas partes redactaron conjuntamente** los siguientes textos, en adelante «los Textos»:

1. La documentación jurídica del proyecto: política de privacidad, evaluación de impacto
   relativa a la protección de datos, registro de actividades de tratamiento, contrato de
   prestación de servicios con encargo de tratamiento y procedimiento de gestión de brechas
   de seguridad.
2. La política de privacidad que el servidor de aplicación publica en la ruta `/privacy`.
3. Los textos de aceptación de términos y privacidad que la aplicación muestra al usuario,
   en castellano, inglés y catalán.

**Tercero.** Que ambos Cotitulares operan la plataforma como administradores de la misma y
desean, **por su libre voluntad y con conocimiento de sus consecuencias**, compartir al
cincuenta por ciento la titularidad de los derechos de explotación de la Obra y la
titularidad de la marca TaxiCount.

**Cuarto.** Que es intención de las partes inscribir la Obra en el Registro de la Propiedad
Intelectual y solicitar la marca TaxiCount ante la Oficina Española de Patentes y Marcas,
figurando ambos como cotitulares al cincuenta por ciento.
...
Las partes declaran, para que conste con exactitud en cualquier registro:

**a)** La autoría del programa de ordenador —aplicación cliente, servidor de aplicación,
modelo de datos, interfaz, automatización e infraestructura— corresponde **en exclusiva a
D. Didac Oliveras Galvez**.

**b)** Los Textos son **obra en colaboración** de ambas partes, conforme al artículo 7 del
texto refundido de la Ley de Propiedad Intelectual.

**c)** Los derechos morales son **irrenunciables e intransmisibles** y permanecen en su
respectivo autor. Nada de lo pactado en este acuerdo los altera, ni convierte a ninguna de
las partes en autor de lo que no ha creado.

La autoría y la titularidad de los derechos de explotación son cosas distintas: este acuerdo
reparte la segunda al cincuenta por ciento sin modificar la primera.

### Segunda — Cesión del 50% de los derechos de explotación

D. Didac Oliveras Galvez **cede a D. Jordi Pujadas Serra una participación indivisa del
cincuenta por ciento (50%)** de la totalidad de los derechos de explotación sobre la Obra,
comprendiendo los derechos de reproducción, distribución, comunicación pública y
transformación, para **todo el mundo** y por **todo el plazo legal de protección**.

Recíprocamente, D. Jordi Pujadas Serra aporta a la titularidad común la totalidad de los
derechos de explotación que le correspondan sobre su aportación a los Textos.

En consecuencia, los derechos de explotación de la Obra pertenecen a ambos Cotitulares **al
...
Ambas partes serán **cotitulares al cincuenta por ciento** de la solicitud y del eventual
registro de la marca **TaxiCount** ante la Oficina Española de Patentes y Marcas, así como de
cualquier extensión futura de la misma, sea por el Protocolo de Madrid o como marca de la
Unión Europea.

La cotitularidad se rige por el **artículo 46 de la Ley 17/2001, de Marcas**: cada cotitular
podrá por sí solo usar la marca y emprender las acciones civiles y penales para su
protección, notificándolo al otro; en cambio, **la cesión de la marca y la concesión de
licencias requieren el consentimiento de ambos**, y la explotación por un solo cotitular
requiere el consentimiento de la mayoría.

Las partes hacen constar que conocen y aceptan que este régimen otorga a cada uno un **derecho
de veto** sobre la venta y la licencia de la marca.

### Cuarta — Reglas de decisión

**a) Requieren el consentimiento de ambos Cotitulares:**

- La transmisión, gravamen o aportación a un tercero de la Obra o de la marca, total o
  parcial.
- La concesión de licencias exclusivas.
- El abandono, la renuncia o la no renovación de cualquiera de los registros.
- La admisión de nuevos cotitulares o socios en la titularidad.
- La modificación del modelo de precios de la plataforma.
- El cese definitivo de la explotación.

**b) Cada Cotitular puede realizar por sí solo, sin necesidad de autorización:**

- El desarrollo, corrección, mantenimiento y actualización de la Obra, así como la
  publicación de nuevas versiones.
- La operación ordinaria de la plataforma y su comercialización en las condiciones vigentes.
- Las acciones de defensa frente a infracciones de terceros y las medidas urgentes de
  conservación del derecho, incluido el pago de tasas cuyo vencimiento sea inminente.

Las partes hacen constar expresamente que, **al no inscribirse la Obra como obra en
colaboración al cincuenta por ciento**, no resulta de aplicación la exigencia de
consentimiento unánime para modificarla y divulgarla del artículo 7.2 del texto refundido de
la Ley de Propiedad Intelectual, y que rige en su lugar el reparto de facultades de esta
...
los que exigen consentimiento de ambos no se alcanzara acuerdo, las partes se someterán a
...
**a)** D. Jordi Pujadas Serra declara que, fuera de los Textos descritos en el expositivo
segundo, **no ha aportado código fuente, diseño gráfico, modelo de datos ni ningún otro
elemento** susceptible de generar derechos de autor sobre la Obra, y que su restante
colaboración tuvo carácter consultivo: recomendaciones, revisión y criterio técnico.

**b)** D. Didac Oliveras Galvez declara ser autor de la Obra, que ésta es original, que no
infringe derechos de terceros y que sobre ella no pesan cargas ni cesiones previas distintas
de las que resultan de este acuerdo.

**c)** Ambos consienten expresamente la inscripción de la Obra en el Registro de la Propiedad
Intelectual y la solicitud de la marca ante la Oficina Española de Patentes y Marcas
**figurando ambos como cotitulares al cincuenta por ciento**, y autorizan a D. Didac Oliveras
...
Ambas partes se obligan a mantener la confidencialidad de la información técnica y de negocio
a la que accedan con ocasión de esta relación, sin límite temporal, salvo la que sea o pase a
ser pública por vía distinta de su incumplimiento.
